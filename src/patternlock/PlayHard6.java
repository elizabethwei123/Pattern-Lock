...
public class PlayHard6 extends JFrame{
	//Class variables
		private PlayHard6 frame;
		private JPanel contentPane;
		private JButton mainMenuButton;
		private JButton btnInstructions;
	  	private JButton btnExit;
	  	private JTextField jTextField;
	  	private picture1 image1 = new picture1();
		private picture2 image2 = new picture2();
		private picture3 image3 = new picture3();
	  	private picture4 image4 = new picture4();
	  	private picture5 image5 = new picture5();
	  	private picture6 image6 = new picture6();
		...
		private void initialize() {
			...
			number1.setBounds(165, 515, 50, 50);
			frame.getContentPane().add(number1);
			
			JLabel number2 = new JLabel("2");
			number2.setFont(new Font("Traditional Arabic", Font.PLAIN, 35));
			number2.setBounds(380, 515, 50, 50);
			frame.getContentPane().add(number2);
			JLabel number3 = new JLabel("3");
			number3.setFont(new Font("Traditional Arabic", Font.PLAIN, 35));
			number3.setBounds(615, 515, 50, 50);
			frame.getContentPane().add(number3);
			
			JLabel number4 = new JLabel("4");
			number4.setFont(new Font("Traditional Arabic", Font.PLAIN, 35));
			number4.setBounds(165, 280, 50, 50);
			frame.getContentPane().add(number4);
			
			JLabel number5 = new JLabel("5");
			number5.setFont(new Font("Traditional Arabic", Font.PLAIN, 35));
			number5.setBounds(390, 280, 50, 50);
			frame.getContentPane().add(number5);
			
			JLabel number6 = new JLabel("6");
			number6.setFont(new Font("Traditional Arabic", Font.PLAIN, 35));
			number6.setBounds(615, 280, 50, 50);
		...
		public void showPictures(){
			//1st position
			image1.setLocation(100, 350);
			contentPane.add(image1); 
			contentPane.updateUI();
			

			image2.setLocation(325, 350);
			contentPane.add(image2); 
			contentPane.updateUI();
			
			image3.setLocation(550, 350);
			contentPane.add(image3); 
			contentPane.updateUI();
			
			image4.setLocation(100, 125);
			contentPane.add(image4); 
			contentPane.updateUI();
			
			image5.setLocation(325, 125);
			contentPane.add(image5); 
			contentPane.updateUI();
			
			image6.setLocation(550, 125);
		    ...
		    timer.schedule(new TimerTask() {
		    	public void run() {
		    		...
		    		if(sub<0){
						...
						//ask
						final int ask = (int)(Math.random()*6 + 1);
						...
						btnSubmit.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								...
								if(ask == 5){
									switch(image5.numb1()){
									case 21:
										if(pattern[0] == 5 && pattern[1] == 4 && pattern[2] == 2 && pattern[3] == 6 && pattern[4] == 8 && pattern[5] == 7
										&&pattern[6] == 0 && pattern[7] == 0 && pattern[8] == 0){
											//Makes an instance of the InstructionFrame
											WinFrame winframe = new WinFrame();
									      	//Set properties of the frame
										...
										break;
							    case 22: 
							    	if(pattern[0] == 1 && pattern[1] == 4 && pattern[2] == 5 && pattern[3] == 8 && pattern[4] == 9 && pattern[5] == 0
									&&pattern[6] == 0 && pattern[7] == 0 && pattern[8] == 0){
							    		//Makes an instance of the InstructionFrame
							    		WinFrame winframe = new WinFrame();
								      	//Set properties of the frame
							    	...
							    	break;
							    case 23:
							    	if(pattern[0] == 4 && pattern[1] == 8 && pattern[2] == 9 && pattern[3] == 6 && pattern[4] == 3 && pattern[5] == 5
									&&pattern[6] == 7 && pattern[7] == 0 && pattern[8] == 0){
							    		//Makes an instance of the InstructionFrame
							    		WinFrame winframe = new WinFrame();
								      	//Set properties of the frame
								...
								break;
							    case 24:
							    	if(pattern[0] == 3 && pattern[1] == 6 && pattern[2] == 9 && pattern[3] == 8 && pattern[4] == 5 && pattern[5] == 2
									&&pattern[6] == 1 && pattern[7] == 0 && pattern[8] == 0){
							    		//Makes an instance of the InstructionFrame
							    		WinFrame winframe = new WinFrame();
								      	//Set properties of the frame
								      	winframe.setSize(800,600);
							    	...
							    	break;
							    case 25:
							    	if(pattern[0] == 4 && pattern[1] == 2 && pattern[2] == 6 && pattern[3] == 5 && pattern[4] == 8 && pattern[5] == 0
									&&pattern[6] == 0 && pattern[7] == 0 && pattern[8] == 0){
							    		//Makes an instance of the InstructionFrame
							    		WinFrame winframe = new WinFrame();
								      	//Set properties of the frame
								...
								if(ask == 6){
									switch(image6.numb1()){
									case 26:
								    	if(pattern[0] == 2 && pattern[1] == 3 && pattern[2] == 5 && pattern[3] == 4 && pattern[4] == 7 && pattern[5] == 8
										&&pattern[6] == 0 && pattern[7] == 0 && pattern[8] == 0){
								    		//Makes an instance of the InstructionFrame
								    		WinFrame winframe = new WinFrame();
									      	//Set properties of the frame
								    	...
								    	break;
								    case 27:
								    	if(pattern[0] == 2 && pattern[1] == 3 && pattern[2] == 6 && pattern[3] == 8 && pattern[4] == 5 && pattern[5] == 1
										&&pattern[6] == 0 && pattern[7] == 0 && pattern[8] == 0){
								    		//Makes an instance of the InstructionFrame
								    		WinFrame winframe = new WinFrame();
									      	//Set properties of the frame
								    	...
								    	break;
								    case 28:
								    	if(pattern[0] == 7 && pattern[1] == 8 && pattern[2] == 5 && pattern[3] == 4 && pattern[4] == 1 && pattern[5] == 0
										&&pattern[6] == 0 && pattern[7] == 0 && pattern[8] == 0){
								    		//Makes an instance of the InstructionFrame
								    		WinFrame winframe = new WinFrame();
									      	//Set properties of the frame
								    	...
								    	break;
								    case 29:
								    	if(pattern[0] == 1 && pattern[1] == 5 && pattern[2] == 4 && pattern[3] == 8 && pattern[4] == 6 && pattern[5] == 2
										&&pattern[6] == 0 && pattern[7] == 0 && pattern[8] == 0){
								    		//Makes an instance of the InstructionFrame
								    		WinFrame winframe = new WinFrame();
									      	//Set properties of the frame
								    	...
								    	break;
								    case 30:
								    	if(pattern[0] == 1 && pattern[1] == 2 && pattern[2] == 6 && pattern[3] == 5 && pattern[4] == 8 && pattern[5] == 7
										&&pattern[6] == 0 && pattern[7] == 0 && pattern[8] == 0){
								    		//Makes an instance of the InstructionFrame
								    		WinFrame winframe = new WinFrame();
									      	//Set properties of the frame
